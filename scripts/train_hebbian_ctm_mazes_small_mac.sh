#!/bin/bash
# Hebbian CTM training on mazes-small dataset for Mac (Apple Silicon)
# Same as baseline CTM but with Hebbian lateral connections enabled
...
--batch_size_test 32 \
--n_test_batches 50 \
--log_dir logs/hebbian/mazes-small-mac \
--track_every 2000 \
--save_every 1000 \
